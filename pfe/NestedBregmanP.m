function [Yfinal,EigVal]= NestedBregmanP(I,J,Wval, Yin, p, miu, r,rex,rscale,rlb,sigma,tol)
if nargin < 8
...
if ~exist('rlb','var') || isempty(rscale)
    rlb = 1e-6;
end
%
pridx = J>I;
...
clear ridx_M cidx_M vidx_M

[total,m] = size(Yin);
W = sparse(Iidx,Jidx,Widx,total,total);
clear I J Wval
