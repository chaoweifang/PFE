function seism_bdry(database,dset,inDir,outDir,nthresh)
...
if exist(fullfile(outDir,'eval_fb_prcurve.txt'),'file')
    disp('bdry metrics already evaluated!');
    return
end
...
parfor i = 1 : numel(iids)
    ...
    seism_bdry_image(inFile, gtFile, evFile, nthresh);
end
...
%collect benchmarks
collect_seism_bdry(outDir,thresh)
